...
const TodoList = () => {
    ...
    const setLoggedInUserName = () => {
        // Example: Fetch the user's name from wherever it's stored (e.g., localStorage) and set it
    ...
    return (
        ...
        <div className=" todolist">
           ...
           <div className='welcome-card-area'>
            ...
            <span className='log-in-as'>Log in as  <span className='loginName'>{loggedInAs}</span></span>
